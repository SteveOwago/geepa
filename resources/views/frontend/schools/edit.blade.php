                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.schools.update", [$school->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="name" id="name" value="{{ old('name', $school->name) }}" required>
                            @if($errors->has('name'))
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="academic_year" id="academic_year" required>
                                ...
                                @foreach(App\Models\School::ACADEMIC_YEAR_SELECT as $key => $label)
                                    <option value="{{ $key }}" {{ old('academic_year', $school->academic_year) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $school->email) }}" required>
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="city" id="city" value="{{ old('city', $school->city) }}" required>
                            @if($errors->has('city'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('city') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="detailed_location" id="detailed_location" value="{{ old('detailed_location', $school->detailed_location) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_office_box" id="post_office_box" value="{{ old('post_office_box', $school->post_office_box) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_2" id="contact_2" value="{{ old('contact_2', $school->contact_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_4" id="contact_4" value="{{ old('contact_4', $school->contact_4) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_3" id="contact_3" value="{{ old('contact_3', $school->contact_3) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_1" id="contact_1" value="{{ old('contact_1', $school->contact_1) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="website" id="website" value="{{ old('website', $school->website) }}">
...
<script>
    ...
    url: '{{ route('frontend.schools.storeMedia') }}',
    maxFilesize: 3, // MB
