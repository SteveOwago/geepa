                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.schools.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="detailed_location" id="detailed_location" value="{{ old('detailed_location', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="post_office_box" id="post_office_box" value="{{ old('post_office_box', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_2" id="contact_2" value="{{ old('contact_2', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_4" id="contact_4" value="{{ old('contact_4', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_3" id="contact_3" value="{{ old('contact_3', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="contact_1" id="contact_1" value="{{ old('contact_1', '') }}" required>
