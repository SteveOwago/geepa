    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.schools.update", [$school->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('detailed_location') ? 'is-invalid' : '' }}" type="text" name="detailed_location" id="detailed_location" value="{{ old('detailed_location', $school->detailed_location) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('post_office_box') ? 'is-invalid' : '' }}" type="text" name="post_office_box" id="post_office_box" value="{{ old('post_office_box', $school->post_office_box) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_2') ? 'is-invalid' : '' }}" type="text" name="contact_2" id="contact_2" value="{{ old('contact_2', $school->contact_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_4') ? 'is-invalid' : '' }}" type="text" name="contact_4" id="contact_4" value="{{ old('contact_4', $school->contact_4) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_3') ? 'is-invalid' : '' }}" type="text" name="contact_3" id="contact_3" value="{{ old('contact_3', $school->contact_3) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('contact_1') ? 'is-invalid' : '' }}" type="text" name="contact_1" id="contact_1" value="{{ old('contact_1', $school->contact_1) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('website') ? 'is-invalid' : '' }}" type="text" name="website" id="website" value="{{ old('website', $school->website) }}">
